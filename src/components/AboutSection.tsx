        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <img
              src="/NK.jpeg"
              alt="Nadeera Withana"
              className="w-full h-auto rounded-2xl object-contain shadow-lg border-4 border-purple-400 max-w-md"
            />
            {/* My Interests */}
